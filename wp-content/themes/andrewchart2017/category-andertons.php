...
<header class="page-hero-header">
  ...
  <div class="hero-image-container"
    ...
    data-hero-image-s="<?php echo wp_get_attachment_image_src(413, 'uncropped_s')[0]; ?>">
    <div class="hero-fullres-container"></div>
    <div class="hero-placeholder-container" style="background-image: url('<?php echo wp_get_attachment_image_src(413, 'uncropped_tiny')[0]; ?>')"></div>
  </div>
